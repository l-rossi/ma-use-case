import re
import unittest
from modules.atoms.application.atom_service import _insert_atom_spans, _find_atom_spans
...
class TestAtomService(unittest.TestCase):
    ...
    def test_insert_atom_spans_empty_text(self):
        ...
        result = _insert_atom_spans(text, atom_spans)
    ...
    def test_find_atom_spans_empty_text(self):
        ...
        text = ""
        spans = list(_find_atom_spans(text))
    ...
    def test_roundtrip_insert_find(self):
        ...
        # Insert spans
        tagged_text = _insert_atom_spans(original_text, original_spans)

        # Find spans
        found_spans = list(_find_atom_spans(tagged_text))
    ...
    def test_mutual_inverse_find_then_insert(self):
        ...
        reconstructed_text = _insert_atom_spans(text_without_tags, found_spans)

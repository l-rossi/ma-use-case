    ...
    <Markdown
      components={{
        ...
        ol: ({ className, children, ...props }) => (
          <ol className={cn('list-decimal pl-8 break-words w-full overflow-hidden mb-2', className)} {...props}>
            {children}
          </ol>
        ),
        ul: ({ className, children, ...props }) => (
          <ul className={cn('list-disc pl-8 break-words w-full overflow-hidden mb-2', className)} {...props}>
            {children}
          </ul>
        ),
      }}

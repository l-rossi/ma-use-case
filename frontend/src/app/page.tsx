...
export default function Home() {
  return (
    <div className={'size-full grid grid-cols-10 grid-rows-4 gap-2'}>
      <RegulationFragments className={'col-span-4 row-span-2'} />

      <Explanations className={'col-span-4 row-span-2'} />

      <AgenticLogs className={'col-span-2 row-span-2'} />

      <Atoms className={'col-span-4 row-span-2'} />

      <Rules className={'col-span-4 row-span-2'} />
